  ...
  return (
    <>
      ...
      <ScreenShell title="GitHub 配置" subtitle="供 AI 创建修复分支和 Draft PR" safeAreaEdges={['bottom']} bottomInsetClassName="pb-8">
        <AdminSection title="仓库" detail="默认使用你的 trilogys/GateNest，也可填写其他 owner/repository 或 GitHub URL。">
          <AdminField label="仓库地址" value={config.repository} onChangeText={(value) => update('repository', value)} placeholder="trilogys/GateNest" autoCapitalize="none" autoCorrect={false} />
